...
CPPFILES='actorspawner audio background effectspawner flagpole levelwarp powerup profile rotcontroller savefile system tilegod tileset/anim tileset/grass tileset/profoverride tileset/rand tileset/common zone'
