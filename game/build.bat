...
SET CPPFILES="audio effectspawner levelwarp powerup profile rotcontroller savefile system tilegod tileset\anim tileset\grass tileset\profoverride tileset\rand tileset\common zone"
